...
//                echo '<pre>';print_r($post);echo'</pre>';
		...
		$post_link =  get_permalink($post->ID);
                $post_date = the_date('', '<h2>', '</h2>', FALSE);
                $post_author = get_the_author('', '<h2>', '</h2>', FALSE);
		...
		$slider_gallery.= '<br/><span class="chpcs_title"><a  style=" text-decoration:none;" href="'.$post_link.'">'.$post_title.'</a></span><br/>';
                ...
                if($post_date){
                   $slider_gallery.= '<div class="calender"><i class="fa fa-calendar"></i>'.$post_date.'</div><div class="admin"><i class="fa fa-user"></i>'.  $post_author.'</div>'; 
                }
		if($display_excerpt){
